...
ref = computeDBZ(fh, 5, 0)[1:-1,1:-1,ept-60:ept+40]
...
#cs = pyplot.contourf(xvals, z, f, levels=np.arange(20,300,30), cmap=pyplot.get_cmap('Reds'), alpha=0.6)
...
#cs3 = pyplot.contourf(xvals, z, pgmlt, cmap=pyplot.get_cmap('Blues_r'), alpha=0.6)
#cs3 = pyplot.contourf(xvals, z, psmlt, cmap=pyplot.get_cmap('Blues_r'), alpha=0.6)
#cs3 = pyplot.contourf(xvals, z, cooling, cmap=pyplot.get_cmap('Blues_r'), alpha=0.6)
...
pyplot.ylim((0,12))
pyplot.xlim((20,60))
pyplot.colorbar(cs3, orientation='horizontal')
